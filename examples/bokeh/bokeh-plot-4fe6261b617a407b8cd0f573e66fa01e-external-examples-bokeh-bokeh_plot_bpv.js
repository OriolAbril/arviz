(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("d924c42c-6360-429c-9ba2-226283c1a687");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd924c42c-6360-429c-9ba2-226283c1a687' but no matching script tag was found.")
        }
