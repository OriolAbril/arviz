(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("5c74de4e-ff8a-43f5-86dc-9d9abc7dba0f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '5c74de4e-ff8a-43f5-86dc-9d9abc7dba0f' but no matching script tag was found.")
        }
