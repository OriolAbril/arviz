(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("2ffa13c2-1792-42a7-ba50-b51db3b5f3ab");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '2ffa13c2-1792-42a7-ba50-b51db3b5f3ab' but no matching script tag was found.")
        }
