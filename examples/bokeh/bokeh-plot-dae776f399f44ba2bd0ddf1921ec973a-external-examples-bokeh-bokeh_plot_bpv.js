(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("729d348a-f8bc-4510-bf94-fbb40cf55135");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '729d348a-f8bc-4510-bf94-fbb40cf55135' but no matching script tag was found.")
        }
