(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("d4869786-1107-4a0b-b512-fba3a64df806");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd4869786-1107-4a0b-b512-fba3a64df806' but no matching script tag was found.")
        }
