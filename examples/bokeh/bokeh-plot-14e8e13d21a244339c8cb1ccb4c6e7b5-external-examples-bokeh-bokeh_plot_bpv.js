(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("b6268946-6564-4438-9319-b6ef708e7c82");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b6268946-6564-4438-9319-b6ef708e7c82' but no matching script tag was found.")
        }
