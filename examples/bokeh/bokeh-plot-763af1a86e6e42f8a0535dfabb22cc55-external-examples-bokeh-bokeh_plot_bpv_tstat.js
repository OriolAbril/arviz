(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("4150b396-326a-47d2-a96f-996ce7fedde0");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '4150b396-326a-47d2-a96f-996ce7fedde0' but no matching script tag was found.")
        }
