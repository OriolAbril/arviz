(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("2c15d8b4-10f4-4331-88b6-b74091b218b4");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '2c15d8b4-10f4-4331-88b6-b74091b218b4' but no matching script tag was found.")
        }
