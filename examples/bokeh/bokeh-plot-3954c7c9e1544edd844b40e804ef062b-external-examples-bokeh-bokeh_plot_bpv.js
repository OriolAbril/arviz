(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("276e2a83-67e3-4cd1-b1eb-688f68beb86b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '276e2a83-67e3-4cd1-b1eb-688f68beb86b' but no matching script tag was found.")
        }
