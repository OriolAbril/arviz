(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("b19dae35-4a39-49a5-820d-149eec6f2263");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b19dae35-4a39-49a5-820d-149eec6f2263' but no matching script tag was found.")
        }
