(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("eb095ed3-2123-4d54-9ecb-80589f1c3ad6");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eb095ed3-2123-4d54-9ecb-80589f1c3ad6' but no matching script tag was found.")
        }
