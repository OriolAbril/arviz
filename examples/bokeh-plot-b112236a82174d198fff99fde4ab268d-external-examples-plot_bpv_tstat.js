(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("6f1ffb8a-fbad-41eb-a1bd-1893bada23b7");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '6f1ffb8a-fbad-41eb-a1bd-1893bada23b7' but no matching script tag was found.")
        }
