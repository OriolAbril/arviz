(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("6ebaeaf3-5f1c-42d0-98ad-0fef89acffff");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '6ebaeaf3-5f1c-42d0-98ad-0fef89acffff' but no matching script tag was found.")
        }
